...
class KSize {
  ...
  static const double margin15xHalf = 62.0;
  ...
  static const double fontSize6XS = 8;
  ...
  static const double avatar1XSHalf = 18;
  ...
  static const double buttonWidthL = 100.0;

  static const double selectorHeight = 56.0;
  static const double infoBalanceHeight = 76.0;
  ...
  static const ShapeBorder bottomSheetShape = RoundedRectangleBorder(
    borderRadius: BorderRadius.vertical(top: Radius.circular(KSize.radiusL)),
  );

...
class _Translations$common$de extends Translations$common$ru {
	...
	@override String get errorTitle => 'Etwas ist schiefgelaufen';
...
class _Translations$contacts$de extends Translations$contacts$ru {
	...
	@override String get phoneSectionHint => 'Anrufe und WhatsApp';
...
extension on TranslationsDe {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'contacts.phoneSectionHint' => 'Anrufe und WhatsApp',

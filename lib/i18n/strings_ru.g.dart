...
class Translations$tour$ru {
	...
	/// ru: 'Также Кищенко А. М. является автором гобелена «Чернобыль» (1991), который был передан в дар ООН и сегодня украшает её штаб-квартиру в Нью-Йорке. Генеральный секретарь ООН сравнил его с «Герникой» Пикассо.'
	String get chernobylBody => 'Также Кищенко А. М. является автором гобелена «Чернобыль» (1991), который был передан в дар ООН и сегодня украшает её штаб-квартиру в Нью-Йорке. Генеральный секретарь ООН сравнил его с «Герникой» Пикассо.';

	/// ru: 'У истоков «Вселенского реализма»'
	String get originsTitle => 'У истоков «Вселенского реализма»';

	/// ru: 'Александр Михайлович Кищенко (1933–1997). Живописец. Философ. Монументалист. Родился в хуторе Белый Колодезь (ныне Богучарский район, Воронежская область) и обрёл мировую известность как автор самого большого в мире «Гобелена века».'
	String get originsBody => 'Александр Михайлович Кищенко (1933–1997). Живописец. Философ. Монументалист. Родился в хуторе Белый Колодезь (ныне Богучарский район, Воронежская область) и обрёл мировую известность как автор самого большого в мире «Гобелена века».';

	/// ru: 'Масштаб гобелена века'
	String get scaleTitle => 'Масштаб гобелена века';

	/// ru: '«Гобелен века» — это полотно, выполненное в технике ручного ткачества, размером 19 × 14 метров (эквивалентно пятиэтажному зданию), весом более тонны. Внесён в Книгу рекордов Гиннесса в 1999 году как самый большой в мире гобелен.'
	String get scaleBody => '«Гобелен века» — это полотно, выполненное в технике ручного ткачества, размером 19 × 14 метров (эквивалентно пятиэтажному зданию), весом более тонны. Внесён в Книгу рекордов Гиннесса в 1999 году как самый большой в мире гобелен.';
}
...
class Translations$bio$feature$ru {
	...
	/// ru: 'Подарок ООН от Республики Беларусь'
	String get unGiftLabel => 'Подарок ООН от Республики Беларусь';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'tour.gotIt' => 'Понятно',
			'tour.back' => 'Назад',
			'tour.chernobylBody' => 'Также Кищенко А. М. является автором гобелена «Чернобыль» (1991), который был передан в дар ООН и сегодня украшает её штаб-квартиру в Нью-Йорке. Генеральный секретарь ООН сравнил его с «Герникой» Пикассо.',
			'tour.originsTitle' => 'У истоков «Вселенского реализма»',
			'tour.originsBody' => 'Александр Михайлович Кищенко (1933–1997). Живописец. Философ. Монументалист. Родился в хуторе Белый Колодезь (ныне Богучарский район, Воронежская область) и обрёл мировую известность как автор самого большого в мире «Гобелена века».',
			'tour.scaleTitle' => 'Масштаб гобелена века',
			'tour.scaleBody' => '«Гобелен века» — это полотно, выполненное в технике ручного ткачества, размером 19 × 14 метров (эквивалентно пятиэтажному зданию), весом более тонны. Внесён в Книгу рекордов Гиннесса в 1999 году как самый большой в мире гобелен.',
			'language.label' => 'Язык',

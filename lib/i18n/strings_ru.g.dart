...
class Translations$tour$ru {
	...
	/// ru: 'Александр Михайлович Кищенко (1933–1997). Живописец. Философ. Монументалист. Родился в хуторе Белый Колодезь (ныне Богучарский район, Воронежская область) и обрёл мировую известность.'
	String get originsBody => 'Александр Михайлович Кищенко (1933–1997). Живописец. Философ. Монументалист. Родился в хуторе Белый Колодезь (ныне Богучарский район, Воронежская область) и обрёл мировую известность.';

	/// ru: 'Масштаб гобелена века'
	String get scaleTitle => 'Масштаб гобелена века';

	/// ru: 'Полотно размером 19 × 14 метров (около 300 кв. м), весом более тонны — размером с пятиэтажное здание. Внесён в Книгу рекордов Гиннесса.'
	String get scaleBody => 'Полотно размером 19 × 14 метров (около 300 кв. м), весом более тонны — размером с пятиэтажное здание. Внесён в Книгу рекордов Гиннесса.';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'tour.originsBody' => 'Александр Михайлович Кищенко (1933–1997). Живописец. Философ. Монументалист. Родился в хуторе Белый Колодезь (ныне Богучарский район, Воронежская область) и обрёл мировую известность.',
			'tour.scaleTitle' => 'Масштаб гобелена века',
			'tour.scaleBody' => 'Полотно размером 19 × 14 метров (около 300 кв. м), весом более тонны — размером с пятиэтажное здание. Внесён в Книгу рекордов Гиннесса.',
			'language.label' => 'Язык',

...
// //   @override
// //   Widget build(BuildContext context) {
// //     return Container(margin: const EdgeInsets.symmetric(vertical: 10), child: const FlutterLogo());
// //   }
// // // }
// 
...
// //   Widget build(BuildContext context) {
// //     final animation = listenable as Animation<double>;
// //     final baseColor = _colorTween.evaluate(animation) ?? Colors.transparent;
// //     return Center(
// //       child: Container(
// //         height: _sizeTween.evaluate(animation),
// //         width: _sizeTween.evaluate(animation),
// //         decoration: BoxDecoration(
// //           color: baseColor.withValues(alpha: _opacityTween.evaluate(animation)),
...
// // // }
// 
// // // class _MultiPropertyDemoState extends State<MultiPropertyDemo> with SingleTickerProviderStateMixin {
// //   late AnimationController _controller;
// //   late Animation<double> _animation;
// 
// //   @override
...
// //                 context,
// //               ).push(MaterialPageRoute<void>(builder: (context) => const BasicExplicitAnimation())),
// //               child: const Text('Basic Explicit'),
// //             ),
// //             ElevatedButton(
// //               onPressed: () => Navigator.of(
// //                 context,
// //               ).push(MaterialPageRoute<void>(builder: (context) => const AnimatedWidgetDemo())),
// //               child: const Text('Animated Widget'),
// //             ),
// //             ElevatedButton(
// //               onPressed: () => Navigator.of(
// //                 context,
// //               ).push(MaterialPageRoute<void>(builder: (context) => const AnimatedBuilderDemo())),
// //               child: const Text('Animated Builder'),
// //             ),
// //             ElevatedButton(
// //               onPressed: () => Navigator.of(
// //                 context,
// //               ).push(MaterialPageRoute<void>(builder: (context) => const MultiPropertyDemo())),

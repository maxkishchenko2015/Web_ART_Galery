...
// 
// //     return Scaffold(body: width >= 600 ? _buildLargeLayout() : _buildSmallLayout());
// //   }
// 
...
// //               NavigationRailDestination(icon: Icon(Icons.search), label: 'Search'),
// //               NavigationRailDestination(icon: Icon(Icons.person), label: 'Profile'),
// //             ],
// //           ),

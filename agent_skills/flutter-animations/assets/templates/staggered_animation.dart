...
// 
// //   late final Animation<double> opacity = Tween<double>(begin: 0.0, end: 1.0).animate(
// //     CurvedAnimation(
// //       parent: controller,
...
// //   );
// 
// //   late final Animation<double> width = Tween<double>(begin: 50.0, end: 150.0).animate(
// //     CurvedAnimation(
// //       parent: controller,
...
// //   );
// 
// //   late final Animation<double> height = Tween<double>(begin: 50.0, end: 150.0).animate(
// //     CurvedAnimation(
// //       parent: controller,
...
// //       BorderRadiusTween(begin: BorderRadius.circular(4), end: BorderRadius.circular(75)).animate(
// //         CurvedAnimation(
// //           parent: controller,
...
// //       );
// 
// //   late final Animation<Color?> color = ColorTween(begin: Colors.red, end: Colors.orange).animate(
// //     CurvedAnimation(
// //       parent: controller,
...
// //     final animatedColor = (color.value ?? Colors.transparent).withValues(alpha: opacity.value);
// //     return Center(
// //       child: Container(
// //         width: width.value,
// //         height: height.value,
...
// //           final intervalStart = start / _animationDuration.inMilliseconds.toDouble();
// //           final intervalEnd = end / _animationDuration.inMilliseconds.toDouble();
// 
